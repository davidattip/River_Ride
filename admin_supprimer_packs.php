...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="navbar-brand" href="index.php">Accueil</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        <a class="nav-link" aria-current="page" href="admin_afficher_packs.php">Les Packs</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="admin_packs">Nouveau</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" style="font-weight: bold;" href="admin_supprimer_packs.php">Suppression</a>
        </li>

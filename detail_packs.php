...
<div class="container">
    <a href="packs.php" class="navbar-brand d-flex align-items-center">
        ...
        <div class="col-md-8">
            <div class="card shadow-sm" >
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="detail_packs.php?commander=<?= $produit->id ?>"><button type="button" class="btn btn-sm btn-success">Commander</button></a>
                    </div>
